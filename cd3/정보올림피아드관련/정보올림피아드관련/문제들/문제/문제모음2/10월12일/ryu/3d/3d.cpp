...
#define MaxN 5
ifstream in ( "stickmove.in" );
ofstream out ("stickmove.out");
			            ...
			            double x3, double y3, double x4, double y4, int f_b )
{
	...
	for ( i = 0; i < N; i ++ ) {
		...
		if ( crosscheck ( x1, y1, x2, y2, Stick[i][0], Stick[i][1], Stick[i][2], Stick[i][3] ) ) {
		   ...
		   ( ccw ( x1, y1, x2, y2, Stick[i][0], Stick[i][1] ) > 0 &&
		     ccw ( x2, y2, x3, y3, Stick[i][0], Stick[i][1] ) > 0 &&
			 ccw ( x3, y3, x4, y4, Stick[i][0], Stick[i][1] ) > 0 ) ) {
			sw = 1;
		} else if ( 
		   ( ccw ( x1, y1, x2, y2, Stick[i][2], Stick[i][3] ) > 0 &&
		     ccw ( x2, y2, x3, y3, Stick[i][2], Stick[i][3] ) > 0 &&
			 ccw ( x3, y3, x4, y4, Stick[i][2], Stick[i][3] ) > 0 ) ) {
			sw = 1;
		}
		if ( sw ) {
